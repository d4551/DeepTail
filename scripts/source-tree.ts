...
export const ROOT = new URL(stryMutAct_9fa48("2624") ? "" : (stryCov_9fa48("2624"), '../'), import.meta.url).pathname;
...
export function onlyPresent(files: readonly SourceFile[]): SourceFile[] {
  if (stryMutAct_9fa48("2625")) {
    ...
    stryCov_9fa48("2625");
    return stryMutAct_9fa48("2626") ? files : (stryCov_9fa48("2626"), files.filter(stryMutAct_9fa48("2627") ? () => undefined : (stryCov_9fa48("2627"), file => existsSync(file.path))));
  }
}

/** The command that answers which files the repository ships. */
export const LISTING_COMMAND = ['git', '--no-optional-locks', 'ls-files', '--cached', '--others', '--exclude-standard', '-z'] as const;
...
export function listedFiles(output: string, extensions: readonly string[]): SourceFile[] {
  if (stryMutAct_9fa48("2628")) {
    ...
    return stryMutAct_9fa48("2629") ? output.split('\0').toSorted().map(label => ({
      label,
      path: `${ROOT}${label}`
    })) : (stryCov_9fa48("2629"), output.split(stryMutAct_9fa48("2630") ? "" : (stryCov_9fa48("2630"), '\0')).filter(stryMutAct_9fa48("2631") ? () => undefined : (stryCov_9fa48("2631"), label => stryMutAct_9fa48("2634") ? label !== '' || extensions.some(extension => label.endsWith(extension)) : stryMutAct_9fa48("2633") ? false : stryMutAct_9fa48("2632") ? true : (stryCov_9fa48("2632", "2633", "2634"), (stryMutAct_9fa48("2636") ? label === '' : stryMutAct_9fa48("2635") ? true : (stryCov_9fa48("2635", "2636"), label !== (stryMutAct_9fa48("2637") ? "Stryker was here!" : (stryCov_9fa48("2637"), '')))) && (stryMutAct_9fa48("2638") ? extensions.every(extension => label.endsWith(extension)) : (stryCov_9fa48("2638"), extensions.some(stryMutAct_9fa48("2639") ? () => undefined : (stryCov_9fa48("2639"), extension => stryMutAct_9fa48("2640") ? label.startsWith(extension) : (stryCov_9fa48("2640"), label.endsWith(extension))))))))).toSorted().map(stryMutAct_9fa48("2641") ? () => undefined : (stryCov_9fa48("2641"), label => stryMutAct_9fa48("2642") ? {} : (stryCov_9fa48("2642"), {
      label,
      path: stryMutAct_9fa48("2643") ? `` : (stryCov_9fa48("2643"), `${ROOT}${label}`)
    }))));
  }
}
...
export function readListing(exitCode: number, stdout: string, stderr: string): string {
  if (stryMutAct_9fa48("2644")) {
    ...
    stryCov_9fa48("2644");
    if (stryMutAct_9fa48("2647") ? exitCode === 0 : stryMutAct_9fa48("2646") ? false : stryMutAct_9fa48("2645") ? true : (stryCov_9fa48("2645", "2646", "2647"), exitCode !== 0)) throw new Error(stryMutAct_9fa48("2649") ? `` : (stryCov_9fa48("2649"), `source-tree: git ls-files exited ${String(exitCode)}: ${stderr}`));
    return stdout;
  }
}
...
export function repositoryFiles(extensions: readonly string[]): SourceFile[] {
  if (stryMutAct_9fa48("2650")) {
    ...
    stryCov_9fa48("2650");
    const listed = Bun.spawnSync(stryMutAct_9fa48("2651") ? [] : (stryCov_9fa48("2651"), [...LISTING_COMMAND]), stryMutAct_9fa48("2652") ? {} : (stryCov_9fa48("2652"), {
      cwd: ROOT,
      stderr: stryMutAct_9fa48("2653") ? "" : (stryCov_9fa48("2653"), 'pipe')
    }));
