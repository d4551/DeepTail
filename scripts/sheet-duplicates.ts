...
export function duplicateRulesets(label: string, text: string): Offence[] {
  if (stryMutAct_9fa48("470")) {
    ...
    const offences: Offence[] = stryMutAct_9fa48("471") ? ["Stryker was here"] : (stryCov_9fa48("471"), []);
    for (const rule of rulesetsOf(text)) {
      if (stryMutAct_9fa48("472")) {
        {}
      } else {
        stryCov_9fa48("472");
        const key = stryMutAct_9fa48("473") ? `` : (stryCov_9fa48("473"), `${rule.selector} { ${rule.body} }`);
        const first = seen.get(key);
        if (stryMutAct_9fa48("476") ? first !== undefined : stryMutAct_9fa48("475") ? false : stryMutAct_9fa48("474") ? true : (stryCov_9fa48("474", "475", "476"), first === undefined)) {
        ...
        offences.push(stryMutAct_9fa48("480") ? {} : (stryCov_9fa48("480"), {
          label,
          line: rule.line,
          why: stryMutAct_9fa48("481") ? `` : (stryCov_9fa48("481"), `duplicate-ruleset: ${rule.selector} is declared more than once (first at line ${String(first)})`)
        }));
      }
    }
    return offences;
