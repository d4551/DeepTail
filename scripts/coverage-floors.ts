...
export const FLOORS: Readonly<Record<string, number>> = {
  ...
  'apps/deeptail/tests/a11y-audit.ts': 13.46,
  'apps/deeptail/tests/audit-evidence.ts': 2.38,
  'apps/deeptail/tests/audit-rules.ts': 100,
  'apps/deeptail/tests/audit.ts': 10.17,
  'apps/deeptail/tests/structure-dialog.ts': 100,
  'apps/deeptail/tests/structure-elements.ts': 100,
  ...
  'apps/deeptail/tests/structure-ramp.ts': 100,
  'apps/deeptail/tests/structure-report.ts': 100,
  'apps/deeptail/tests/structure-rows.ts': 100,
  'apps/deeptail/tests/structure-scroll.ts': 100,
  'apps/deeptail/tests/structure-shell.ts': 100,
  'apps/deeptail/tests/structure-typography.ts': 100,
  ...
  'scripts/paint-contract.ts': 100,
  'scripts/paint-document-rules.ts': 100,
  'scripts/paint-gate.ts': 100,
  'scripts/paint-index.ts': 100,
  'scripts/paint-shell-rules.ts': 100,
  'scripts/paint-stamp.ts': 100,
  'scripts/paint-tree.ts': 100,
  'scripts/pins.ts': 100,
  ...
  'tests/paint-fixture.ts': 100,
  'tests/shell-chrome-double.ts': 100,
  'tests/structure-dispatch-page.ts': 100,
  'tests/structure-double.ts': 100,
  'tests/structure-page-fixture.ts': 100,
  'tests/structure-shipped.ts': 100,
  'tests/structure-typography-fixture.ts': 100,
