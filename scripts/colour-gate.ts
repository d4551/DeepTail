 ...
 */
const RAW_LITERAL = new RegExp(stryMutAct_9fa48("152") ? `` : (stryCov_9fa48("152"), `#[0-9a-f]{3,8}\\b|\\b(?:${NAMED.join(stryMutAct_9fa48("153") ? "" : (stryCov_9fa48("153"), '|'))})\\b`), stryMutAct_9fa48("154") ? "" : (stryCov_9fa48("154"), 'iu'));

/** The override flag, assembled so the gate's own source does not carry it. */
const OVERRIDE = (stryMutAct_9fa48("155") ? [] : (stryCov_9fa48("155"), [stryMutAct_9fa48("156") ? "" : (stryCov_9fa48("156"), '!'), stryMutAct_9fa48("157") ? "" : (stryCov_9fa48("157"), 'important')])).join(stryMutAct_9fa48("158") ? "Stryker was here!" : (stryCov_9fa48("158"), ''));
 ...
 */
const OVERRIDE_FLAG = new RegExp(stryMutAct_9fa48("159") ? `` : (stryCov_9fa48("159"), `!\\s*${stryMutAct_9fa48("160") ? OVERRIDE : (stryCov_9fa48("160"), OVERRIDE.slice(1))}\\b`), stryMutAct_9fa48("161") ? "" : (stryCov_9fa48("161"), 'iu'));
...
export function scanColour(label: string, value: string, line: number, paletteDefinition: boolean): Offence[] {
  if (stryMutAct_9fa48("162")) {
    ...
    stryCov_9fa48("162");
    const offences: Offence[] = stryMutAct_9fa48("163") ? ["Stryker was here"] : (stryCov_9fa48("163"), []);
    const colour = paletteDefinition ? RAW_LITERAL.exec(value) : RAW.exec(value);
    if (stryMutAct_9fa48("166") ? colour === null : stryMutAct_9fa48("165") ? false : stryMutAct_9fa48("164") ? true : (stryCov_9fa48("164", "165", "166"), colour !== null)) {
      if (stryMutAct_9fa48("167")) {
        {}
      } else {
        stryCov_9fa48("167");
        offences.push(stryMutAct_9fa48("169") ? {} : (stryCov_9fa48("169"), {
          label,
          line,
          why: stryMutAct_9fa48("170") ? `` : (stryCov_9fa48("170"), `${colour[0]} is written out rather than read from the palette in tokens.css`)
        }));
      }
    }
    if (stryMutAct_9fa48("172") ? false : stryMutAct_9fa48("171") ? true : (stryCov_9fa48("171", "172"), OVERRIDE_FLAG.test(value))) {
      if (stryMutAct_9fa48("173")) {
        {}
      } else {
        stryCov_9fa48("173");
        offences.push(stryMutAct_9fa48("175") ? {} : (stryCov_9fa48("175"), {
          label,
          line,
          why: stryMutAct_9fa48("176") ? `` : (stryCov_9fa48("176"), `an ${OVERRIDE} override wins every cascade; restate the selector instead`)
        }));
      }
    }
    return offences;
