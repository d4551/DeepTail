...
const zh = {
  ...
  'denial.none': '这台主机没有授予你执行此操作的权限。',
  'denial.expired': '此操作的授权已过期，请重试。',
  'denial.stale': '这份授权的版本比现有的旧，请重试。',
  'denial.subject': '这份授权不属于这台主机。',
  'denial.context': '这台主机的授权已被更换，请重新配对。',
  'denial.malformed': '无法读取这台主机的授权，已清除全部授权。',
  'denial.native': '已拒收一份并非由本机原生层签发的授权。',
  'denial.trace': '参考编号 {trace}。',
  'unavailable.noHosts': '尚未配对任何主机。',
  'unavailable.noActiveHost': '请先选择一台主机。',
  'unavailable.notRunning': '这个会话此刻没有正在运行的回合。',
  'unavailable.notUnauthorized': '这台主机不需要重新配对。',
  'unavailable.noTailnet': '尚未连接 Tailscale。',
  'invalid.noHost': '注册表里已经没有这台主机。',
  'invalid.noSession': '这个会话已经不存在。',
  'unwired.noClient': '当前没有已打开的客户端可返回。',
  'unwired.noTailnet': '本机没有保存 Tailscale 凭据。',
  'unwired.noHost': '没有可操作的主机。',
...
const en = {
  ...
  'denial.none': 'This host has not granted you this action.',
  'denial.expired': 'The grant for this has expired. Try again.',
  'denial.stale': 'That grant is an older revision than the one held. Try again.',
  'denial.subject': 'That grant belongs to a different host.',
  'denial.context': 'This host’s authority was replaced. Pair it again.',
  'denial.malformed': 'The grants for this host could not be read, so all were cleared.',
  'denial.native': 'A grant that did not come from this device’s native layer was refused.',
  'denial.trace': 'Reference {trace}.',
  'unavailable.noHosts': 'No host is paired yet.',
  'unavailable.noActiveHost': 'Choose a host first.',
  'unavailable.notRunning': 'That session has no turn running right now.',
  'unavailable.notUnauthorized': 'This host does not need re-pairing.',
  'unavailable.noTailnet': 'No tailnet is connected.',
  'invalid.noHost': 'That host is no longer in the registry.',
  'invalid.noSession': 'That session no longer exists.',
  'unwired.noClient': 'No client is open to go back from.',
  'unwired.noTailnet': 'No tailnet credential is stored on this device.',
  'unwired.noHost': 'There is no host to act on.',
