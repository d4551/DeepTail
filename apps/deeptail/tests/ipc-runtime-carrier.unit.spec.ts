/**
 * The carrier socket, driven through the runtime this process installed.
 *
 ...
 * the `unit` suffix in the name is on it.
 *
 * The double's own reset behaviour is held separately, in
 * `tests/zz-ipc-probe.spec.ts`; the channel the library builds in
 * `ipc-runtime.unit.spec.ts`; and the same registration on a live page in
