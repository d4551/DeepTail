...
import { type AnswerTable, type Harness, startHarness, type Violation } from './harness.ts'
...
/** Both paired hosts with a populated roster. */
function fleet(extra: Partial<AnswerTable> = {}): AnswerTable {
